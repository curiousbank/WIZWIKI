...
Rails.application.configure do
  ...
  # Force HTTPS semantics at the Rails layer too. Nginx/Cloudflare handle the
  # public redirect path; Rails still marks cookies secure and emits HSTS.
  ...
  config.action_mailer.default_url_options = {
    host: ENV.fetch("WIZWIKI_APP_HOST", "wizwiki.local"),
    protocol: ENV.fetch("WIZWIKI_APP_PROTOCOL", "https")
  }
  ...
  config.action_mailer.smtp_settings = {
    ...
    port: 587,
    domain: ENV.fetch("WIZWIKI_APP_HOST", "wizwiki.local"),
