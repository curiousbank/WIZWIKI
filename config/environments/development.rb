...
Rails.application.configure do
  ...
  # Allow the Cloudflare tunnel host while running the bootstrap app locally.
  config.hosts << "wizwiki.local"
  config.hosts << "www.wizwiki.local"
